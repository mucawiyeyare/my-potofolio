    ...
    <div className="min-h-screen py-10 sm:py-16 lg:py-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative w-full h-80 sm:h-96 rounded-2xl shadow-2xl overflow-hidden group">
              <img
                src="/profile.jpg"
              ...
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center justify-between gap-2">
                ...
                <span className="text-[10px] sm:text-xs px-2.5 py-1 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-200 flex-shrink-0">Developer & Teacher</span>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-8 sm:space-y-12">
              {timeline.map((item, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className={`absolute left-2.5 sm:left-6.5 w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border-2 sm:border-4 border-white dark:border-gray-900 ${
                    item.type === 'work' 
                      ? 'bg-blue-600' 
                      : 'bg-green-600'
                  }`}></div>
                  ...
                  <div className="ml-8 sm:ml-16 bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg border border-gray-200 dark:border-gray-700 flex-1">
                    <div className="flex items-center mb-2">
                      <span className="text-xs sm:text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/50 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                        {item.year}
                      </span>
                      <div className="ml-3">
                        {item.type === 'work' ? (
                          <FaBriefcase className="text-blue-600 dark:text-blue-400 w-3.5 h-3.5 sm:w-4 sm:h-4" />
                        ) : (
                          <FaGraduationCap className="text-green-600 dark:text-green-400 w-4 h-4 sm:w-5 sm:h-5" />
                        )}
                      </div>
                    </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
              <div className="p-3 sm:p-0">
                ...
                <div className="text-xs sm:text-base text-blue-100">Projects Completed</div>
              </div>
              <div className="p-3 sm:p-0">
                <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">1+</div>
                <div className="text-xs sm:text-base text-blue-100">Years Experience</div>
              </div>
              <div className="p-3 sm:p-0">
                <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">∞</div>
                <div className="text-xs sm:text-base text-blue-100">Cups of Coffee</div>
              </div>
              <div className="p-3 sm:p-0">
                <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">24/7</div>
                <div className="text-xs sm:text-base text-blue-100">Learning Mode</div>
              </div>
            </div>
          </motion.div>
        </div>
