    ...
    >
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-1">
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          <span className="text-[11px] font-semibold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full border border-gray-200 dark:border-gray-600">
            {category}
          </span>
        </div>
        ...
        <div className="flex flex-wrap gap-1.5 mb-5">
          {techList.map((t) => (
            <span
              key={t}
              className="px-2.5 py-1 text-xs font-semibold border border-gray-200 dark:border-gray-700 rounded-full text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/60"
            >
              {t.toUpperCase()}
            </span>
          ))}
        ...
        <div className="pt-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between gap-2">
          {domain ? (
            <a
              ...
              className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white truncate max-w-[130px] font-mono"
              title={domain}
            >
              {domain}
            </a>
    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="space-y-3 sm:space-y-4">
                ...
                >
                  Hi, I'm Eng Abdirahman Mohamed Ibrahim
                </motion.h1>
            ...
            >
              <div className="relative w-full h-80 sm:h-96 lg:h-[480px] rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-800 group">
                ...
                <div className="absolute bottom-3 left-3 right-3 sm:bottom-5 sm:left-5 sm:right-5 p-3 sm:p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center justify-between shadow-xl gap-2">
                  <div className="min-w-0 pr-2">
                    <p className="text-[10px] sm:text-xs uppercase tracking-wider text-gray-300 font-semibold truncate">Full-Stack &amp; Data Analyst</p>
                    <p className="text-xs sm:text-base font-bold truncate">Eng Abdirahman Mohamed</p>
                  </div>
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-medium bg-white/10 text-white border border-white/30 flex-shrink-0">
      ...
      <section id="live-projects" className="py-12 sm:py-20 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs font-bold mb-3 border border-gray-200 dark:border-gray-700">
                <span className="flex h-2 w-2 relative">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-gray-900 dark:bg-white opacity-75"></span>
            ...
            <Link
              to="/projects"
              className="inline-flex items-center text-gray-900 dark:text-white font-semibold hover:underline text-sm sm:text-base"
            >
      ...
      <section className="py-20 bg-gray-900 dark:bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-white dark:text-gray-900">
              Ready to Start Your Project?
            </h2>
            <p className="text-xl text-gray-300 dark:text-gray-600 max-w-2xl mx-auto">
              Let's collaborate and bring your ideas to life with clean engineering
